...
PowerSendMsg powerSendMsg;
PowerRecvMsg powerRecvMsg;
OrgPowerRecvMsg orgPowerRecvMsg;
/**
...
void CAN1_RX0_IRQHandler(void)
{
	if (CAN_GetITStatus(CAN1, CAN_IT_FMP0) != RESET)
	{
		...
		case 0x111:  //1ms
		{
			...
			can1Feedback.Jgmt_ShootNum = (int16_t)((Can1RxMsg.Data[0] << 8) | (Can1RxMsg.Data[1]));		   //裁判系统射击数量
			can1Feedback.Jgmt_OutSpd = (int16_t)((Can1RxMsg.Data[2] << 8) | (Can1RxMsg.Data[3])) / 100.0f; //出膛速度
			can1Feedback.Jgmt_Heat = (int16_t)((Can1RxMsg.Data[4] << 8) | (Can1RxMsg.Data[5]));			   //实时热量数据
		...
		case 0x403: //20ms
		{
			can1Feedback.jgmtOffline = 0;
			can1Feedback.jgmtOfflineCheck = 0;
			can1Feedback.max_hp = (int16_t)((Can1RxMsg.Data[0] << 8) | (Can1RxMsg.Data[1]));   //最高血量
			can1Feedback.CoolRate = (int16_t)((Can1RxMsg.Data[2] << 8) | (Can1RxMsg.Data[3])); //冷却速率
			can1Feedback.MaxHeat = (int16_t)((Can1RxMsg.Data[4] << 8) | (Can1RxMsg.Data[5]));  //热量上限
			break;
		}
		case 0x404:  //
		{
			...
			can1Feedback.stageRemainTime = (int16_t)((Can1RxMsg.Data[4] << 8) | (Can1RxMsg.Data[5]));
			break;
		}
		case 0x110:   //2ms
		{
			powerSendMsg = *((PowerSendMsg*)(Can1RxMsg.Data));
			break;
		}
		case 0x103:  //5ms
		{
...
//			orgPowerRecvMsg = *((OrgPowerRecvMsg*)(Can1RxMsg.Data));
