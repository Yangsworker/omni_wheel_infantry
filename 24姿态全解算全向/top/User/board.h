...
#define USE_OPERATOR_AUTO_DEC(x) inline x operator--(x &rs,int){x oldEnum = rs;if ((int)rs > 0 )rs = (x)(rs - 1);else rs = (x)(ENUM_NUM(x) - 1);return oldEnum;}
